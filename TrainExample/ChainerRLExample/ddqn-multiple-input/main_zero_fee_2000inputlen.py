...
for episode in range(0,5):
    ...
    for idx in range(0, len(y_train)):#TODO
        ...
        buy_sell_count, pass_count, money, ethereum, total_money = action_if(action,buy_sell_count,pass_count,money,ethereum,total_money,current_price)
...
agent.save('chainerRLAgentFinal-main_zero_fee_2000inputlen-reward-bug-fix')
